...
Results_File = open(r"/home/ali/My_Localization_Folder/testing-dwm1001-dev-modules/Files_On_Desktop/src/coop_con_loc/src/Results_File.txt","w+")
Results_File_EST = open(r"/home/ali/My_Localization_Folder/testing-dwm1001-dev-modules/Files_On_Desktop/src/coop_con_loc/src/Results_File_EST.txt","w+")
Results_File_Freq_Pos = open(r"/home/ali/My_Localization_Folder/testing-dwm1001-dev-modules/Files_On_Desktop/src/coop_con_loc/src/Results_File_Freq_Pos.txt","w+")
...
#	P_KF_z = np.eye(4) # Using KF based on constant jerk
	...
	while not rospy.is_shutdown():
		...
		Results_File.write("%d %d %d %d\r\n" % (rospy.get_time(),X[0],X[1],pos_z_Flt))
		...
		data_Pos_UWB = {"Pos_UWB_mm":[X[0][0],X[1][0],pos_z_Flt[0]]} #X[2][0]
