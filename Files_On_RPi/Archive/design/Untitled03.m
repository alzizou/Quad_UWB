...
Dist01 = 6027; % sqrt( (Exact(1)-Anchor01(1))^2 + (Exact(2)-Anchor01(2))^2 + (Exact(3)-Anchor01(3))^2 ) + randi([-200,200],1,1);
Dist02 = 3968; % sqrt( (Exact(1)-Anchor02(1))^2 + (Exact(2)-Anchor02(2))^2 + (Exact(3)-Anchor02(3))^2 ) + randi([-200,200],1,1);
Dist03 = 5393; % sqrt( (Exact(1)-Anchor03(1))^2 + (Exact(2)-Anchor03(2))^2 + (Exact(3)-Anchor03(3))^2 ) + randi([-200,200],1,1);
Dist04 = 2134; %sqrt( (Exact(1)-Anchor04(1))^2 + (Exact(2)-Anchor04(2))^2 + (Exact(3)-Anchor04(3))^2 ) + randi([-200,200],1,1);
