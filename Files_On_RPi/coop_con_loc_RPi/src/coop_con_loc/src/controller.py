...
#			ed_x = (ep_x - error_previous_x) / dt
#			ed_y = (ep_y - error_previous_y) / dt
#			ed_z = (ep_z - error_previous_z) / dt
			...
			#ducky
#			print(colored(("CONTROLLER POS ERROR (m): ep_x=%.3f , ep_y=%.3f , ep_z=%.3f" % (ep_x,ep_y,ep_z)),"red"))
...
#			evd_x = (ev_x - error_previous_vx) / dt
#			evd_y = (ev_y - error_previous_vy) / dt
#			evd_z = (ev_z - error_previous_vz) / dt
