...
//    mat_cns1(Initial_inp,X_out,3,1);
//    std::cout << "distances:" << ' ' << All_Dist[0][0] << ' ' << All_Dist[1][0] << ' ' << All_Dist[2][0] << ' ' << All_Dist[3][0] << ' ' << All_Dist[4][0] << ' ' << All_Dist[5][0] << ' ' << All_Dist[6][0] << ' ' << All_Dist[7][0] << std::endl;
