...
Results_File_py = open(r"/root/coop_con_loc_nano/src/coop_con_loc/src/Results_File_py.txt","w+")
#Results_File_EST = open(r"/root/coop_con_loc_nano/src/coop_con_loc/src/Results_File_EST.txt","w+")
#Results_File_Freq_Pos = open(r"/root/coop_con_loc_nano/src/coop_con_loc/src/Results_File_Freq_Pos.txt","w+")
#Results_File_NED_LOC = open(r"/root/coop_con_loc_nano/src/coop_con_loc/src/Results_File_NED_LOC.txt","w+")
...
#------------------------------------------------------------------------
#Anchors Information at HumanITAS office
Num_Anchors = 8
...
#-----------------------------------------------------------------------
#Anchors Information at AML McGill
#Num_Anchors = 8
#All_Anchors = np.zeros([3,Num_Anchors])
#All_Anchors[0:3,0] = [1050,1000,1000] #A
#All_Anchors[0:3,1] = [-1300,3100,1000] #B
#All_Anchors[0:3,2] = [-5700,-2850,1000] #C
#All_Anchors[0:3,3] = [-5700,2800,1000] #D
#All_Anchors[0:3,4] = [1050,1000,2500] #E
#All_Anchors[0:3,5] = [-1300,3100,2500] #F
#All_Anchors[0:3,6] = [-5700,-2850,2500] #G
#All_Anchors[0:3,7] = [-5700,2800,2500] #H
#-----------------------------------------------------------------------
...
#	P_KF_z = np.eye(4) # Using KF based on constant jerk
	...
	psi_coordinate_conversion = 35.0 * np.pi / 180.0 #angle between North and X axis of the UWB system(35.0)
...
#		print(colored(("Estimated Position(mm): %d %d %d" % (X_new[0],X_new[1],X_new[2])),"green"))
